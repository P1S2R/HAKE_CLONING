...
#Create & Recode By Parvez Chowdory
...
╰╯╱╱╰╯╱╰┻╯╰━╯╱╰╯╱╰━━━┻━━━━╯
                     I P LOVE S YOU
|------------------------------------------------------=|
|FACEBOOK: https://www.facebook.com/istiak.ahamed.Parvez      
|---------------------------------=--------------------=|
|WHATSAPP:01301125467___________________________________|                                    
|---------------------------------=--------------------=|
|Github:P1S2R ______________________________________|                                 
|---------------------------------=--------------------=|
|Stutas:PAID_300TK______________________________________|
|---------------------------------=---------------------|
\033[0;96m─────────────────────────────────────────────────────────────""")
...
def menu():
  ...
  print("\033[0;96m─────────────────────────────────────────────────────────────")
  print("\033[0;96m╔══\033[0;97m[ Parvez_VAU ]")
  print("\033[0;96m║")
